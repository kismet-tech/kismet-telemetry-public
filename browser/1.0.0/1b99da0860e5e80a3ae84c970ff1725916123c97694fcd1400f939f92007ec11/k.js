/** Kismet browser telemetry 1.0.0. Fixed release; upgrades require a new URL. */
;
(function () {
    'use strict';
            ...
            (function (evtName, map) {
                window.addEventListener('kismet:visitor:' + evtName, function (e) {
                    try {
                        ...
                        var capiConsent = _config && shouldSetCookies(_config.countryCode || 'US');
    ...
    function bootstrap() {
        try {
            ...
            xhr.onload = function () {
                ...
                resolveSession(_config.countryCode || 'US');
