...
// default is only as good as the header: off Cloudflare / Vercel there is none,
// unknown is treated as allowed, and every visitor gets a cookie. So the site's
// consent hook is the mechanism and geography is the fallback.
...
/**
 * The default gate: unknown country (missing, XX, T1) is allowed; a listed
 * country is denied.
 ...
 * (a bare Cloud Run / Apache / Azure hop), which the default gate treats as allowed.
